       ...
       unsigned long val, void *v)
{
       ...
       if (strcmp(policy->governor->name, "pixel_schedutil")) {
               cpufreq_cpu_put(policy);
               return NOTIFY_OK;
       }
       ...
       if (strcmp(policy->governor->name, "smurfutil_felx")) {
               cpufreq_cpu_put(policy);
               return NOTIFY_OK;
       }

       if (strcmp(policy->governor->name, "pixel_smurfutil")) {
               cpufreq_cpu_put(policy);
               return NOTIFY_OK;
       }
       ...
       if (strcmp(policy->governor->name, "helix_smurfutil")) {
               cpufreq_cpu_put(policy);
               return NOTIFY_OK;
       }
